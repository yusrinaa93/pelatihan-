...
<div class="max-w-7xl mx-auto space-y-8 px-4 pb-12">
    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        @forelse ($courses as $course)
            {{-- PERBAIKAN: Gunakan Storage Facade agar gambar muncul di server --}}
                ...
                <div class="flex flex-1 flex-col gap-4 p-5">
                    ...
                    <div class="flex flex-col gap-2 pt-4 mt-auto sm:flex-row">
                        ...
                        <button type="button"
                                ...
                                onclick="showCourseDetail({{ $course->id }}, '{{ addslashes($course->judul) }}', '{{ addslashes(str_replace(array("\r", "\n"), '', $course->deskripsi)) }}')">
